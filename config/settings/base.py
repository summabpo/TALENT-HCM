...
MIDDLEWARE = [
    ...
    'apps.core.middleware.LoginRedirectMiddleware',
]
...
SESSION_COOKIE_NAME = os.environ.get('SESSION_COOKIE_NAME', 'nomiweb_session')
SESSION_COOKIE_DOMAIN = os.environ.get('SESSION_COOKIE_DOMAIN', '.nomiweb.co')
